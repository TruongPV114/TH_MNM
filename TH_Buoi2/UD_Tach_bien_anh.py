...
def edge_detection():
    ...
    if original_image is not None:
        ...
        display_image_in_new_window(edges_rgb, "Edge Detection")
        processed_image = edges_rgb  # Cập nhật ảnh đã xử lý
...
tk.Button(control_frame, text="Tách biên", command=edge_detection).grid(row=1, column=1, pady=10)
